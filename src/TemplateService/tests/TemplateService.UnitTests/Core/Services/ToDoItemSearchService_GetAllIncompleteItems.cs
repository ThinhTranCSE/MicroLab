...
using TemplateService.Core.ProjectAggregate;
using TemplateService.Core.Services;
using TemplateService.SharedKernel.Interfaces;
using Moq;
using Xunit;

namespace TemplateService.UnitTests.Core.Services
{
