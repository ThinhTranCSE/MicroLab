...
**Updated `tests\TemplateService.FunctionalTests\TemplateService.FunctionalTests.csproj`:**
- Removed: `Microsoft.EntityFrameworkCore.InMemory`
- Added: `Testcontainers` and `Testcontainers.MsSql`

### 2. CustomWebApplicationFactory

**File:** `tests\TemplateService.FunctionalTests\CustomWebApplicationFactory.cs`
...
```bash
dotnet test tests\TemplateService.FunctionalTests\TemplateService.FunctionalTests.csproj
```
