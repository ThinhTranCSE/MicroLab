using TemplateService.Core.ContributorAggregate.Events;
using TemplateService.Core.Interfaces;

namespace TemplateService.Core.ContributorAggregate.Handlers;
    ...
    IEmailSender emailSender) : INotificationHandler<ContributorNameUpdatedEvent>
{
    ...
    {
        logger.LogInformation("Handling Contributor Name Updated event for {contributorId}",
