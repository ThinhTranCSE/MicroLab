...
1. Set `TemplateService.AspireHost` as the startup project
...
```bash
dotnet ef migrations add MigrationName -c AppDbContext -p ../TemplateService.Infrastructure/TemplateService.Infrastructure.csproj -s TemplateService.Web.csproj -o Data/Migrations
```

To update the database:
```bash
dotnet ef database update -c AppDbContext -p ../TemplateService.Infrastructure/TemplateService.Infrastructure.csproj -s TemplateService.Web.csproj
```
